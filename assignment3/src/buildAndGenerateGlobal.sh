...
javac -cp --target 8 genclass.jar */*.java */*/*.java
...
cp serverSide/main/SimulPar.class serverSide/main/ServerRestaurantGeneralRepos.class dirGeneralRepos/serverSide/main
...
cp serverSide/main/SimulPar.class serverSide/main/ServerRestaurantBar.class dirBar/serverSide/main
...
cp serverSide/main/SimulPar.class serverSide/main/ServerRestaurantTable.class dirTable/serverSide/main
...
cp serverSide/main/SimulPar.class serverSide/main/ServerRestaurantKitchen.class dirKitchen/serverSide/main
