...
sshpass -f password ssh sd207@l040101-ws02.ua.pt 'mkdir -p test/Restaurant'
sshpass -f password ssh sd207@l040101-ws02.ua.pt 'rm -rf test/Restaurant/*'
sshpass -f password scp dirKitchen.zip sd207@l040101-ws02.ua.pt:test/Restaurant
