 ...
 * provide means for it to be printed in the logging file. It is implemented
 * using semaphores for synchronization. All public methods are executed in
 * mutual exclusion. There are no internal synchronization points.
 */
public class GeneralRepos {
	...
	public synchronized void initSimulation(String logFileName, int nIter) {
