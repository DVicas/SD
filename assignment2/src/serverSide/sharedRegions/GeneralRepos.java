...
public class GeneralRepos
{
	...
	private void reportStatus ()
	{
		...
		switch(waiterState)
		{
		case WaiterStates.APPRAISING_SITUATION: line += "APPST  "; break;
		case WaiterStates.PRESENTING_THE_MENU: line += "PRSMN  "; break;
		case WaiterStates.TAKING_THE_ORDER: line += "TKODR  "; break;
		case WaiterStates.PLACING_THE_ORDER: line += "PCODR  "; break;
		...
		for(int i = 0; i < SimulPar.N; i++)
		{
			...
			case StudentStates.CHATTING_WITH_COMPANIONS: line += "CHTWC "; break;
			case StudentStates.ENJOYING_THE_MEAL: line += "EJYML "; break;
			case StudentStates.PAYING_THE_MEAL: line += "PYTBL "; break;
	 ...
	 */
	public synchronized void setStudentState(int id, int value) {
	 ...
	 */
	public synchronized void setStudentState(int id, int value, boolean hold) {
		this.studentState[id] = value;
	}
